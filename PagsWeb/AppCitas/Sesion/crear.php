		...
		<form method="post" action="crear.php">
                    <ul class="actions">
                       ...
                       if (login_check($mysqli)){
                           if (isset($_GET['table'])){
                           if ($_GET['table'] == 'clinic'){crearClinica(); }
                           if ($_GET['table'] == 'date'){ crearCita();}
                           if ($_GET['table'] == 'room'){ crearConsultorio();}
                           if ($_GET['table'] == 'doctor'){crearDoctor();}
                           if ($_GET['table'] == 'user'){ crearUsuario();}
                       }
                       else{echo "Inserted";}
                           }
                       else{
